  ...
  return (
    ...
    >
      <div className="relative flex-shrink-0">
        <div className={`w-9 h-9 rounded-full ${getAvatarColor(conversation.fullName)} flex items-center justify-center overflow-hidden`}>
          {conversation.avatar ? (
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between">
          ...
          {conversation.unreadCount > 0 && (
            <span className="ml-1 px-1.5 min-w-[16px] text-center bg-primary-500 text-white text-[9px] rounded-full font-medium">
